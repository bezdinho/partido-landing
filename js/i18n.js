...
const T = {
  en: {
    ...
    how: {
      ...
      s1t:'Create Your Match',  s1p:'Set format, level, date, time, and atmosphere. Your match goes live in 30 seconds and is visible to nearby players.',
      s2t:'Players Find You',   s2p:'Nearby players matching your level see your game and request to join. You review their profiles and approve.',
      s3t:'Show Up & Play',     s3p:'Squad confirmed, field booked. Everyone is notified. You just show up and play.',
    },
    org: {
  ...
  fr: {
    ...
    how: {
      ...
      s1t:'Crée ton Match',      s1p:'Définis le format, niveau, date, heure et ambiance. Ton match est en ligne en 30 secondes.',
      s2t:'Les Joueurs te Trouvent', s2p:'Les joueurs de ton niveau voient ton match et demandent à rejoindre. Tu vérifies et approuves.',
      s3t:'Joue',                s3p:'Équipe confirmée, terrain réservé. Tout le monde est notifié. Tu n\'as plus qu\'à venir jouer.',
    },
    org: {
  ...
  ar: {
    ...
    how: {
      ...
      s1t:'أنشئ مباراتك',    s1p:'حدد التنسيق والمستوى والتاريخ والوقت والأجواء. تنطلق مباراتك في 30 ثانية وتظهر للاعبين القريبين.',
      s2t:'اللاعبون يجدونك', s2p:'اللاعبون من مستواك يرون مباراتك ويطلبون الانضمام. أنت تراجع ملفاتهم وتوافق.',
      s3t:'احضر والعب',      s3p:'الفريق مكتمل، الملعب محجوز، الجميع مُبلَّغ. ما عليك سوى الحضور واللعب.',
    },
    org: {
